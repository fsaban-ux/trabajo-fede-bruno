let api = "https://dummyjson.com/products/category/motorcycle"
let api2 = "https://dummyjson.com/products/category/smartphones"
let api3 = "https://dummyjson.com/products/category/cars"


let productsdiv = document.querySelector(".seccion1")
...
let productsdiv2 = document.querySelector(".seccion2")

let categoriesDiv2 = document.querySelector(".lista-home2")
...
fetch(api2)
    ...
    .then(function (data) {
        ...
        for (let i = 0; i < productos.length; i++) {
            productsdiv2.innerHTML += `<article class="articulobotin">
          <img src=${productos[i].thumbnail} alt="Botin2A"> Botin predator
         <p class="titulos">${productos[i].title}</p>
      <p class="precio">${productos[i].price}</p>
      <button class="vermas"><a href="./product.html?id=${productos[i].id}">Ver mas</a></button>
...
let productsdiv3 = document.querySelector(".seccion3")

let categoriesDiv3 = document.querySelector(".lista-home3")
...
fetch(api3)
    ...
    .then(function (data) {
        ...
        for (let i = 0; i < productos.length; i++) {
            productsdiv3.innerHTML += `<article class="articulobotin">
          <img src=${productos[i].thumbnail} alt="Botin2A"> Botin predator
         <p class="titulos">${productos[i].title}</p>
      <p class="precio">${productos[i].price}</p>
      <button class="vermas"><a href="./product.html?id=${productos[i].id}">Ver mas</a></button>
