...
campoEmail.addEventListener('focus', function () {
    if (mmsgEmail) msgEmail.textContent = "";
})
...
campoPass2.addEventListener('blur', function () {
    if (campoPass2.value == "" && msgPass2) {
        msgPass2.textContent = "Repetir contraseña en un campo obligatorio";
    }
})
...
formulario.addEventListener('submit', function (event) {
    ...
    if (msgPass && campoPass.value == "") msgPass.textContent = "La contraseña es obligatoria";
    if (msgPass2 && campoEmail.value == "") msgPass2.textContent = "Repetir contraseña es obligatorio";
